...
export function drawBanks(ctx, worldDistance, cameraWorldX, { hideVillages = false, time = 0, canoeWorldX = null } = {}) {
  ...
  if (!hideVillages) drawVillages(ctx, worldDistance, cameraWorldX, time, canoeWorldX);
}
